...
def main():
    ...
    if(dataset_choice == '1'):
        ...
        # per ottenere il numero di features, sottraiamo il numero di colonne tolte dal dataset durante il preprocessamento
        ...
        # per questo dataset abbiamo tolto due colonne
    ...
    print('\nForma del dataset: %s' % (str(dataset.shape)))
    ...
    # inizio training con best_model
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for batch in range(num_batches):
            ...
            # forward pass, backpropagation e aggiornamento pesi
            phi, labels, activations = forward_pass(X_batch, W, b, activation_function, len(X_batch))

            loss_curr = compute_loss(phi, Y_batch, W, best_lambda, regularization)
        ...
        # facciamo una forward pass così da poter valutare l'andamento dell'accuratezza e della loss durante le epoche
        ...
        loss_per_epoch.append(loss_curr)

    
    plot(accuracy_per_epoch,"accuracy")
    plot(loss_per_epoch,"loss")
